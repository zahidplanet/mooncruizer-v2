...
namespace Gadd420
{
    ...
    [RequireComponent(typeof(XRI_Manager),typeof(AudioSource),typeof(NitrousManager))]
    ...
    public class RB_Controller : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            inputs = GetComponent<XRI_Manager>();
        ...
        void Update()
        {
            ...
            //Log what the current speed is in the console
